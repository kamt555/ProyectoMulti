<%-- 
    Document   : crudTipoEmpresa
    Created on : 05-10-2018, 11:49:15 PM
    Author     : kamt
--%>

<%@page import="com.modelo.TipoEmpresa"%>
<%@page import="java.util.List"%>
<%@page import="com.dao.DaoTipoEmpresa"%>
...
<html>
    <head>
        ...
        <title>Crud Tipo de Empresa</title>
        <script Language='JavaScript'>
            function cargar(idTipoEmpresa,nombre){
               document.frmTipoEmpr.txtCodigo.value=idTipoEmpresa; 
               document.frmTipoEmpr.txtNombre.value=nombre;
		...
		<div id="page-wrapper">
			...
			<!-- Main -->
				<section id="main" class="container 75%">
					<header>
						<h2>Crud Tipo de Empresa</h2>
						<p></p>
					</header>
					<div class="box">
                                            
                                            <form method="post"  name="frmTipoEmpr" action="procesarTipoEmpresa">
					...
					<div class="table-wrapper">
						<table>
							...
							<tbody>
                                                            <%
                                                                DaoTipoEmpresa daoP=new DaoTipoEmpresa();
                                                                List<TipoEmpresa> lst=daoP.mostrarTipoEmpresa();
                                                                for(TipoEmpresa prv:lst){
                
                                                            %>
                                                        <tr>
                                                            <td><%=  prv.getIdTipoEmpresa() %></td>
                                                            <td><%= prv.getNombre()  %></td>
                                                            
                                                            <td><a href="javascript:cargar(<%=prv.getIdTipoEmpresa() %>,'<%=prv.getNombre() %>')">Selecionar</a></td>
